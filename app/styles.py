...
/* pages/login.py uses st.link_button (NOT raw HTML) so the link escapes
   ...
   Material Symbols has no brand logos), the GitHub octocat is injected
   here as a background-image data-URI, scoped to the Supabase GitHub
   OAuth URL via [href*="provider=github"]. */
.stLinkButton a[href*="provider=github"] {
